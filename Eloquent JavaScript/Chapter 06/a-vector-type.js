...
var firstCoordinate = "(1, 2)";
var secondCoordinate = "(2, 3)";
var thirdCoordinate = "(3, 4)";

print("The sum of " + firstCoordinate + " and " + secondCoordinate + " is: " + new Vector(1, 2).plus(new Vector(2, 3)).toString());
print("The difference of " + firstCoordinate + " and " + secondCoordinate + " is: " + new Vector(1, 2).minus(new Vector(2, 3)).toString());
print("The length of coordinate " + thirdCoordinate + " is: " + new Vector(3, 4).length);
